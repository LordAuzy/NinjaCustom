...
namespace NinjaTrader.Custom.Strategies.DAustin.OPNDRV
{
    public class OPNDRV_EntryParameters
    {
        ...
        public double MaxPullbackBarRangeATR { get; set; } = 0.80;
        ...
        public double MaxEntryDistanceATR { get; set; } = 2.30;
    }
    ...
    public class OptimizationParameters_OPNDRV : OptimizationParametersBase
    {
        ...
        public override void CopyFrom(OptimizationParametersBase opf)
        {
            ...
            Time.B4SesssionEndFlattenMin = opFrom.Time.B4SesssionEndFlattenMin;
        ...
        public override void ToStringBuilder(StringBuilder sb)
        {
            ...
            sb.AppendFormat("  B4SessionEndFlattenMin={0}", Time.B4SesssionEndFlattenMin).AppendLine();
            ...
            sb.AppendFormat("  DriveDuration={0}", Entry.DriveDuration).AppendLine();
