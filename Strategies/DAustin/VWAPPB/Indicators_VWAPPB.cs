...
{
    [StrategyComponentId("IDC-VWAPPB")]
    public class Indicators_VWAPPB : IndicatorsBase
    {
        ...
        #region Properties
        private OptimizationParameters_VWAPPB OptParamsVWAPPB { get { return OptParams as OptimizationParameters_VWAPPB; } }
        ...
        public Indicators_VWAPPB(StratBase strat) : base(strat)
        {
