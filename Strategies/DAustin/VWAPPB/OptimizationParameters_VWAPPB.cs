...
{
    public class VWAPPB_EntryParameters
    {
        // --- Indicators ---
    ...
    [StrategyComponentId("OP-VWAPPB")]
    public class OptimizationParameters_VWAPPB : OptimizationParametersBase
    {
        #region Properties
        ...
        public VWAPPB_EntryParameters Entry { get; set; } = new VWAPPB_EntryParameters();
        ...
        public override void SetDefaultValues()
        {
            ...
            General.LoggingMode = LoggingMode.Normal;
        ...
        public override void UpdateStratParamValues()
        {
            ...
            Strat_VWAPPB strat = Strategy as Strat_VWAPPB;
