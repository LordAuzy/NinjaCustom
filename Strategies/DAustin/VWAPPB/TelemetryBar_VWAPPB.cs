...
{
    public class TelemetryBar_VWAPPB : TelemetryBarBase
    {
        #region static
        ...
        #region Constructors
        public TelemetryBar_VWAPPB() : base()
        {

        }

        public TelemetryBar_VWAPPB(StratBase strat, IIndicators indicators) : base(strat, indicators)
        {
